...
export const updateMuteLevel = (level, data) =>
  client.patch(`/mute-levels/${level}`, data).then(r => r.data)
...
export const adjustMuteXP = (discordId, xp) =>
  client.patch(`/mute-xp/${discordId}`, { xp }).then(r => r.data)
...
export const setDebugMode = enabled =>
  client.patch('/settings/debug-mode', { enabled }).then(r => r.data)
